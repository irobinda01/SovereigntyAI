// MIRROR of agent/src/data/ecosystemProtocols.ts (protocol facts only; the live
// checks live in app/api/ecosystem/route.ts). The agent test suite asserts the
// two lists stay identical - edit both together.
//
